...
import 'package:motopickupdriver/controllers/profile/re_verify_phone.dart';
import 'package:motopickupdriver/utils/buttons.dart';
import 'package:motopickupdriver/utils/colors.dart';
import 'package:motopickupdriver/utils/typography.dart';
import 'package:pin_code_fields/pin_code_fields.dart';

class ReVerifyPhone extends StatelessWidget {
  ReVerifyPhone({Key? key}) : super(key: key);
  var controller = Get.put(ReVerifyPhoneController());

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: GetBuilder<ReVerifyPhoneController>(
              ...
              body: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    40.verticalSpace,
                    GetBuilder<ReVerifyPhoneController>(
                      init: ReVerifyPhoneController(),
