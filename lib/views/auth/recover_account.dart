...
import 'package:motopickupdriver/controllers/auth/recover_account.dart';
...
class RecoverAccount extends StatelessWidget {
  ...
  var controller = Get.put(RecoverAccountController());

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: GetBuilder<RecoverAccountController>(
        init: RecoverAccountController(),
                ...
                : SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        40.verticalSpace,
                        GetBuilder<RecoverAccountController>(
                          init: RecoverAccountController(),
                          builder: (value) => Padding(
                            padding: EdgeInsets.symmetric(horizontal: 20.w),
                            child: Text(
                              'Un SMS a été envoyé au ${controller.tmpUser!.phoneNo}, entrez le code reçu pour valider votre demande de récupération de mot de passe.',
                              style: bodyTextStyle,
                            ),
                          ),
                        ),
