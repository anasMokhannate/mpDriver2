...
import 'package:motopickupdriver/controllers/auth/verify_recover_pwd.dart';
...
class VerifyRecoverPwd extends StatelessWidget {
  ...
  var controller = Get.put(VerifyRecoverPwdController());

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: GetBuilder<VerifyRecoverPwdController>(
        init: VerifyRecoverPwdController(),
                ...
                : SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        40.verticalSpace,
                        GetBuilder<VerifyRecoverPwdController>(
                          init: VerifyRecoverPwdController(),
